...
Tailwind CSS v4 进行了一次大更新，之前 v3 的 dark mode 设置方式已经不再适用。但好消息是，v4 优化了 dark mode 的使用，现在能更加简单的为网站设置深浅模式。

### 二、使用 Tailwind v4 新设置

1、首先安装 tailwind v4，官方推荐使用 PostCSS 插件将 tailwind 集成到 next.js 中。（参考[tailwind installation](https://tailwindcss.com/docs/installation/using-postcss)）
...
export default function Page() {
  ...
  return (
    <div className="flex items-center w-36 h-20 p-4 bg-amber-100 dark:bg-black">
